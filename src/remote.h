 ...
 * @param socket_fd_ptr The socket file description pointer.
 *                      It is set if the socket creation was successful,
 ...
 *                      if the socket has been created successfully,
 *                      otherwise to NULL.
 * @return Status:
 *   -  0 => Success.
 ...
 *                         (the receptionist).
 * @param accept_error_policy The policy that should be taken when bad things
 *                            happen while accepting a client connection.
 * @param fork_error_handler The function handler that handles the slave
 *                           creation failure.
 ...
 * @param retry_count The number of times that the client retries to connect
 *                    if there are some "soft" connection errors.
 *
 * @return Status:
 *   -  0 => Success.
