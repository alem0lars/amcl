...
void test_setup_passive_socket() {
  int socket_fd;
  socket_address_t address, address2;
  memset(&address, 0, sizeof(address));
  memset(&address2, 0, sizeof(address2));
...
//  server_address.sin_addr.s_addr = INADDR_ANY; // Any IP address on this host
//  server_address.sin_port = htons(34732);
//
//  log_msg(DEBUG, STANDARD, "test_tcp()", "Started");
//
//  server_pid = fork();
//  if (server_pid < 0) {
//    ret = 1;
...
//
//  log_msg(DEBUG, STANDARD, "test_tcp()", "Finished");
//  return ret;
//}
//
///**
...
// */
//int slave_logic(int slave_socket_fd, socket_address_t* slave_address) {
//  log_msg(DEBUG, STANDARD, "Slave", "Handling a client...");
//  return 0;
//}
